...
public class HotkeuyAdapter2 extends RecyclerView.Adapter {
    ...
    public HotkeuyAdapter2(Context context, List<HomerPopHotkeyinfo.DataBean> list) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new HotkeuyViewHolder2(inflate);
    }

    @Override
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, final int position) {
        HomerPopHotkeyinfo.DataBean dataBean = list.get(position);
        HotkeuyViewHolder2 hvh = (HotkeuyViewHolder2) holder;
    ...
    class HotkeuyViewHolder2 extends RecyclerView.ViewHolder {
        private FlowLayout tv;
        private View view;
        public HotkeuyViewHolder2(@NonNull View itemView) {
            super(itemView);
            view = itemView;
